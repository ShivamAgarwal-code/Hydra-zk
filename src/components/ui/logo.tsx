...
function Logo() {
  return (
    <h1
      className={`${titleFont.className} uppercase  text-5xl drop-shadow-[3px_4px_2px_rgba(0,0,0,0.3)] dark:drop-shadow-[0px_2px_1px_rgba(128,128,128,0.6)]`}
    >
      <span
        className={` ${titleFont2.className} text-violet-500 datk:text-violet-600 text-5xl me-2 relative bottom-1`}
      >
        ZK
      </span>
